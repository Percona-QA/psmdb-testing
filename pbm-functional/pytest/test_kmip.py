...
def cluster(config):
    return Cluster(
        config,
        mongod_extra_args="--enableEncryption --kmipServerName pykmip --kmipPort 5696 --kmipServerCAFile /etc/pykmip/ca.crt --kmipClientCertificateFile /etc/pykmip/mongod.pem",
    )

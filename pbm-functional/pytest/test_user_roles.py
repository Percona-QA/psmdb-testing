...
@pytest.mark.parametrize('restore_type',['part_bck','part_bck_with_ur','full_bck_part_rst_wo_user','full_bck_part_rst_user1','full_bck_part_rst_user2','full_bck','full_pitr'])
...
def test_logical_PBM_T216(start_cluster, cluster, newcluster, restore_type):
    ...
    restore_commands = {
        ...
        'part_bck_with_ur': " --base-snapshot=" + backup_partial_with_ur + pitr + " --ns=administration.*,test_db1.*,test_db2.* --with-users-and-roles",

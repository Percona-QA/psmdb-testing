...
def start_cluster(cluster, request):
    try:
        ...
        result = cluster.exec_pbm_cli(
            "config --set storage.type=azure --set storage.azure.endpointUrl="
            + azure_endpoint
            + " --set storage.azure.account="
            + azure_account
            + " --set storage.azure.container=test-container --set storage.azure.credentials.key="
            + azure_key
            + " --out json --wait"
        )

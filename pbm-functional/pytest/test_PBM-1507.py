...
def rs_encrypted_same_key():
    config = {"_id": "rs1", "members": [{"host": "rs101"}, {"host": "rs102"}, {"host": "rs103"}]}
...
@pytest.mark.parametrize(
    ...
    ids=["same_key", "mixed_key", "mixed_key_fb", "new_key_fb"],
    indirect=True,
)
...
def test_general_PBM_T299(start_cluster, docker_client, backup_type):
    ...
    if not cache_entry:
        ...
        backup_cache[backup_type] = {"backup": backup, "inserted_docs": inserted_docs}

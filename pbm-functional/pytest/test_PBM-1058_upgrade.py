...
def start_cluster(cluster, request):
    try:
        ...
        cluster.create()
        cluster.downgrade(
            tarball="https://downloads.percona.com/downloads/percona-backup-mongodb/percona-backup-mongodb-2.0.4/binary/tarball/percona-backup-mongodb-2.0.4-x86_64.tar.gz"
        )
        cluster.setup_pbm()

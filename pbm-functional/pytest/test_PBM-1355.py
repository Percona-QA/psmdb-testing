...
def newconfig():
    return {
        ...
        "configserver": {
            "_id": "newrscfg",
            "members": [{"host": "newrscfg01"}, {"host": "newrscfg02"}, {"host": "newrscfg03"}],
        },
        "shards": [{"_id": "newrs1", "members": [{"host": "newrs101"}, {"host": "newrs102"}, {"host": "newrs103"}]}],
    }
...
def test_remap_PBM_T265(start_cluster, cluster, newcluster, backup_type):
    ...
    result = newcluster.exec_pbm_cli(

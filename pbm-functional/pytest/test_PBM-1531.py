...
wrong_rs101_cluster = Cluster(
    {"_id": "wrong_rs101", "members": [{"host": "wrong_rs101"}]},
    pbm_mongodb_uri="mongodb://pbm:pbmpass@rs101:27017/?authSource=admin",
)
wrong_rs102_cluster = Cluster(
    {"_id": "wrong_rs102", "members": [{"host": "wrong_rs102"}]},
    pbm_mongodb_uri="mongodb://pbm:pbmpass@rs102:27017/?authSource=admin",
)
wrong_rs103_cluster = Cluster(
    {"_id": "wrong_rs103", "members": [{"host": "wrong_rs103"}]},
    pbm_mongodb_uri="mongodb://pbm:pbmpass@rs103:27017/?authSource=admin",
)
wrong_rscfg01_cluster = Cluster(
    {"_id": "wrong_rscfg01", "members": [{"host": "wrong_rscfg01"}]},
    pbm_mongodb_uri="mongodb://pbm:pbmpass@rscfg01:27017/?authSource=admin",
)
wrong_rscfg02_cluster = Cluster(
    {"_id": "wrong_rscfg02", "members": [{"host": "wrong_rscfg02"}]},
    pbm_mongodb_uri="mongodb://pbm:pbmpass@rscfg02:27017/?authSource=admin",
)
wrong_rscfg03_cluster = Cluster(
    {"_id": "wrong_rscfg03", "members": [{"host": "wrong_rscfg03"}]},
    pbm_mongodb_uri="mongodb://pbm:pbmpass@rscfg03:27017/?authSource=admin",
)

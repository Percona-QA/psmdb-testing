...
def cluster(config):
    return Cluster(
        config,
        mongod_extra_args="--enableEncryption --vaultServerName vault --vaultPort 8200 --vaultTokenFile /etc/vault/token --vaultSecret secret/data/mongo --vaultDisableTLSForTesting",
    )
